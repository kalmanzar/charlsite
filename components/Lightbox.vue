  ...
  <div class="flex flex-1 w-full h-full justify-center">
    <div v-if="!visible" class="lightboxGrid">
      <a class="pinkSelect" href="#" @click.prevent="show(i)" v-for="(image, i) in images" :key="image">
        <img class="imageGalleryItem object-contain" :src="image" />
      </a>
    ...
    <div class="flex lightbox" v-if="visible" @click="hide">
      <div class="flex flex-row">
        <div class="flex flex-none cursor-pointer pinkSelect h-64 xxxs:h-80 md:h-88 place-self-center" @click.stop="prev" :class="{'invisible': ! hasPrev()}">
        ...
        <div class="grow shrink place-self-center" @click.stop="">
          <img class="object-scale-down" :src="images[index]">
        </div>
        <div class="flex flex-none cursor-pointer pinkSelect h-64 xxxs:h-80 md:h-88 place-self-center" @click.stop="next" :class="{'invisible': ! hasNext()}">
